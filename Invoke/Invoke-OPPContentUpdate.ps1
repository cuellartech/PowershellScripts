...
param(
    ...
    [ValidateNotNullOrEmpty()]
    [string]$OfficePackagePath = "\\spsccm\cmsource$\Applications\Microsoft\Office\Office365_Enterprise",

    [parameter(Mandatory = $false, HelpMessage = "Specify the Office application display name.")]
    [ValidateNotNullOrEmpty()]
    [string]$OfficeApplicationName = "Office 365 Enterprise",
    ...
    [parameter(Mandatory = $false, HelpMessage = "When True, don't update the detection method for the specified Office 365 ProPlus application.")]
    [ValidateNotNullOrEmpty()]
